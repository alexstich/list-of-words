...
class DatabaseManager 
{
    ...
    {
        return !self.fetchWords(excludingWords: [], limit: 1, offset: 0).isEmpty
    }
    ...
    func fetchFavoriteWords(limit: Int? = nil, offset: Int = 0) -> [String]
    {
    ...
    func fetchWords(excludingWords excludedWords: [String], limit: Int = 100, offset: Int = 0) -> [String]
    {
    ...
    private func createWordTable()
    {
        ...
        if sqlite3_prepare_v2(db, createWordTableCommand, -1, &createWordTableStatement, nil) == SQLITE_OK {
        ...
        if sqlite3_prepare_v2(db, createIndexStatementString, -1, &createIndexStatement, nil) == SQLITE_OK {
    ...
    private func createFavoriteWordTable()
    {
        ...
        if sqlite3_prepare_v2(db, createFavoriteWordTableCommand, -1, &createFavoriteWordTableStatement, nil) == SQLITE_OK {
