...
class WordDetailsRouter: NSObject, WordDetailsRoutingLogic, WordDetailsDataPassing
{
  ...
  //func navigateToSomewhere(source: WordDetailsViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: WordDetailsDataStore, destination: inout SomewhereDataStore)
  //{
